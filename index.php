...
if($status === 1){
    ...
    <div>
            <form action="" method="POST">   
                ...
                <input type="button" value="注册" id="delu3" onclick="window.location.href='./registery.html'">
            </form>
        </div>
    EOF;
?>
...
?>
    ...
    <div class="middle_right2">
        <div class="middle_right21">
            <div class="zhaung1">党建动态</div>
            <div class="middle_right211">
                <div class="qw">
                    <div class="qww"><a href="">一流专业建设</a></div>
                </div>
                <div class="qe">
                    <div class="qee"><a href="">疫情防控</a></div>
                </div>
                <div class="qr">
                        <div class="qrr"><a href="">理论之窗</a></div>
                </div>
            </div>
        </div>
        <div class="middle_right22">
                <div class="zhaung1">"武"我信息</div>
                <div class="middle_right211">
                    <div class="qh">
                        <div class="qhh"><a href="">巾帼不让须眉</a></div>
                    </div>
                    <div class="qx">
                        <div class="qxx"><a href="">出征前的"排面"</a></div>
                    </div>
                    <div class="ql">
                            <div class="qll"><a href="">足球称霸</a></div>
                    </div>
                </div>
        </div>           
        <div class="middle_right23">
                <div class="zhaung1">学子风采</div>
                <div class="middle_right211">
                    <div class="qq">
                        <div class="qqo"><a href="">信息最不缺奖杯</a></div>
                    </div>
                    <div class="lp">
                        <div class="lpp"><a href="">榜样的故事</a></div>
                    </div>
                    <div class="we">
                            <div class="wee"><a href="">勇夺魁首</a></div>
                    </div>
                </div>
        </div>
    </div>
